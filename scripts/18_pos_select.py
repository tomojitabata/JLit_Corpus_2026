...
⚠ **品詞だけでは固有名詞を落とし切れない。** UniDic は辞書に無い人名を
普通名詞や形状詞と解析することがある（『青年』の「純一」，『坊っちゃん』の
「山嵐」，『黒死館殺人事件』の「法水」）。こうした語は**1作品に集中する**ので，
``--max-work-share``（1作品が度数に占める割合の上限）で落とせる。
同じ作家の複数の作品に出る人物名（宮本百合子の「素子」）は1作品に集中しないので，
``--max-author-share``（1作家が度数に占める割合の上限）で落とす。

**bursty な語**（少数の作品に固まって出る語）は Gries (2008) の DP でも落とせる。
...
の2つを出す。全体の dp は「ある時代に偏る」語も罰してしまう。時代の主題を
