...
CODEBOOK = [
 ...
 ("period5","**学習に使う5区分**。明治前期を中期に畳んだもの。記述統計は period（6区分），モデルの学習は period5 を使う。根拠が文学史ではなく標本の量であることを列で示す（docs/corpus_design.md）","1_明治前期〜中期 / 3_明治後期 / 4_大正 / 5_昭和戦前 / 6_昭和戦後"),
...
def main():
    ...
    lines = [
        ...
        ("                       編集すれば自動で更新される。", False),
        ("expansion_candidates : 増補候補70件。priority 1=明治前期，2=女性作家，3=ジャンル，4=作家平準化，5=欠落補完。", False),
